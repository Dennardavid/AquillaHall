    ...
    .insert([
      {
        ...
        Participation_in_activities: grades.Participation_in_activities,
        Leadership_traits_roles: grades.Leadership_traits_roles,
        Honesty: grades.Honesty,
        Punctuality: grades.Punctuality,
        Obedience: grades.Obedience,
        Attitude_to_work: grades.Attitude_to_work,
        Self_control: grades.Self_control,
        ...
        Relationship_with_teachers: grades.Relationship_with_teachers,
        Relationship_with_pupils: grades.Relationship_with_pupils,
        Creativity: grades.Creativity,
        Sports: grades.Sports,
        Games: grades.Games,
